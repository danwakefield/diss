...
It should be noted that the flowchart is not totally representation of the system and is just here to show the progression of data from beginning to end.
