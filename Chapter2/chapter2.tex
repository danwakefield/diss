...
Shell functions have a dynamic block scope mechanism though it is not automatic, it requires using the \verb!local! command to define variables inside the current variables scope.
