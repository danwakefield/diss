...
Posix suggests that external commands be launched using \verb!execve! which takes the programs name, its full path, any arguments and a copy of all the environmental variables that have been set.  
