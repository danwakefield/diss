...
There are some parts of the design where Go allowed me to be much more concise than C allows dash or bash.
These will be clearly noted and explained in more detail in later sections

Figure~\ref{fig:shell-flowchart} is a visual guide to this section and I will be referring to it often.
It should be noted that the flowchart is not totally representation of the system and is just here to show the progression of data.

The first step we need to do is get the text represents the shell program in some way.
