...
There was also the choice of using a lexer generator such as ANTLR or Ragel.
Also with Go being such a recent language these tools generally dont have good support for it, Ragel being the exception.
