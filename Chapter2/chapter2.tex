...
User defined functions are created using the shell syntax.
Like all other shell code they are represented as an AST.
This means that with each call they are reinterpreted.
