...
I considered it instead of other functional languages as it comes with its own versions of the lex and yacc tools which are useful for creating a language using code generation.
