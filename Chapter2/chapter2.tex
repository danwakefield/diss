...
The lexer also handles alias expansion, not a currently included feature, which can be a tricky problem as it introduces indirect left recursion into the language.
This is a common problem in compiler construction and care must be taken to avoid
