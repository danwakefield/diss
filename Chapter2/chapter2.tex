...
\subsection{Input}
I chose to focus on the internals of the shell before making the input experience 'nicer', because of this only file input is currently supported.
I could also have created a
