...
The spec requires you to explictly mark them using the \verb!export! command and everything is in place for this, namely the Scope and Variable structures.
