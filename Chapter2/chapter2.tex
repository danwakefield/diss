...
The terminal Node of the tree is the NodeCommand which handles execution of system utilites, builtins and user defined functions, the redirection of input and output to the requested files, pipes or file descriptors and 
