...
I considered it instead of other functional languages as it has recently been used to create some the high profile language Hack, a superset of PHP developed at facebook. recent languages including Haxe comes with its own versions of the lex and yacc tools which are useful for creating a language using code generation.
