...
By itself or when followed by a character that would be invalid in the first position of a variable name it becomes a literal character with no special meaning.
