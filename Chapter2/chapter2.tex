...
The expanded arguments are passed through to be used to determine what to execute.
What is executed is decided by the order of precedence laid out in the specification.
This is:
\begin{enumerate*}
