...
Before anything can be executed a whole bunch of different expansions have to be run. These include expanding variables and tildes, arithmetic substitution and filepath globbing in a POSIX shell.
Bash and other modern shells extend these further to include brace expansion,
