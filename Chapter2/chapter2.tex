...
The process of evaluating math is sufficiently complex, especially with the additional features the shell adds such as assignments and a ternary operator, to require the separate construct to parse it.
