...
I then felt that the base case of the remaining options was file input as a pipe can be treated as a file.
...
In this section I will explain the complex shell constr
