...
\lstinputlisting[caption={[fnmatch]fnmatch function. See my fork of the code and tests at \url{https://github.com/Danwakefield/fnmatch}. The original came from a gist published in 2010\label{lst:fnmatch}}]{Appendix1/fnmatch.go}
