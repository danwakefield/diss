...
For example \verb!a + b!, \verb!a * b! and \verb!a *= b!, \verb!a += b! show that behaviour is similar and it is just the operation that differs in most cases .
...
Since Go interfaces can only consist of methods I just changed this to a getter method instead.
