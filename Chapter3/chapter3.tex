...
The fix for this would be very simple, it just requires the addition of a division helper function similar to that used for shifting\cite{lst:arith-shift}. XXX % Add reference to integration test that caught it.
