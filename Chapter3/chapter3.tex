...
We finish lexing when we see two consecutive right brackets while we are not in a bracketed expression.
...
Everything between the two markers is stored in a substitution object an gets passed to 'arith.Parse' when expansion is done.
