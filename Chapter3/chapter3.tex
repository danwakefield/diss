...
\subsection{Parser}
As mentioned early the parser used was a Pratt parser.
It was not completed along with the lexer in the first iteration as had been planned, It took another  
