...
Commands take a list of environment variables each as a string in the form, "VAR_NAME=FOO".
This meant that when I got to the stage when commands where being executed I had to add the environ function to convert the scope to this style of list with the correct precedence.


As I went further into the project I came to the point when commands where being executed on the machine.
To give them access to the variables that had been set 
