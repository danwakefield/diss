...
Emitting is the term given to passing a token through the lexItems channel which allows the parser to collect them.
The token is created using information the lexer holds including the string representation, any substitutions the value is quoted
\subsection{Strings}
