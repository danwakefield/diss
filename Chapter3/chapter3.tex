...
During the third iteration both single and double quotes behaved as raw quotes

\subsection{Variables}
Variables where completed in two stages, simple ones in the fourth iteration alongside extensions to the parser 
