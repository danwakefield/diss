...
\subsection{Variables}
The original Scope object only held information about variables but it was still over designed.
...
I created it this way as I knew that it would affect both commands with temporary assignments and functions using the local builtin.
