...
It was developed iteratively as other elements of the code where completed.
...
During the third iteration this was created to support commands with argue
...
This occurs when variable and command substitutions are unquoted.

Some variables are special and splitting happens even when they are quoted.
When the '\$*' variable occurs quoted it uses the first character of IFS to join the shells positional parameter into a single string.
\begin{verbatim}
IFS='-'
set - a b c
echo $@    # "a" "b" "c"
