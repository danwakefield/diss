...
Subshells come in two forms, the original which uses grave quotes and the 'modern' version which uses '\$( )' as a delimiter.

Only the modern version is implemented in the code
