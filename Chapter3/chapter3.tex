...
When I created the lexComplexVariable function I used a very simple lexer for anything after the operator with the intention of replacing it.
It gathers everything as is upto the next '}' character and uses it as the value.
This means that no substitutions will work.
It also does not take into account the EOF rune
