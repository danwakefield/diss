...
Newlines can also be suppressed during the lexing. 
Instead of being returned as a word like suppressed keywords lexing continues until a non Newline token is found. 
