...
This allows simple utilities to be combined to produce complex transformations which are conducted in memory buffers reducing overhead.
The canonical example of how pipelines can be better than real programs comes from \cite{LITERATE-VS-SHELL}. \cite
\subsection{And Or}
\subsection{List}
