...
\section{Background}
A shell is the smallest possible interface between a user and the operating system kernel API functions.
These functions perform complex tasks like launching executables, connecting to the network and accessing files.
...
These group commands that a user may type to avoid repetition.
...
Every operating system I know of comes with some form of shell, Windows with cmd.exe and Powershell, OSX with bash and linux distributions 
