...
\section{Background}
A shell is an interface between user input and kernel API functions.
It is a Domain Specific Language(DSL) of the shell allows you to interact with the kernel in a simplified fashion launching programs 
