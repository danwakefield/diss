...
The most commonly used shell however is bash, as it comes as the defualt on many systems including OSX and as the login shell for Ubunutu.
It comes with an option flag to switch off the additional features and enable POSIX compatibility, 
