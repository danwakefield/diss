...
The most commonly used shell however is bash, as it comes as the defualt on many systems including OSX and as the login shell for it comes with an option to switch off the additional features posix
