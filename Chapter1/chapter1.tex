...
The project was developed using a combination of processes including Feature Driven Development (FDD) and Test Driven Development (TDD).
This was done as near the beginning of development the program could not be compiled to produce anything useful. TDD allowed me to ensure that the individual components worked while
