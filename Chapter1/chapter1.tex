...
As well as providing this interface almost all shells have control flow structures that allow them to be used as a complete scripting language.
This is often used in automating tasks 
