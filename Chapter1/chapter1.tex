...
Every linux distribution right down to the very smallest\cite{ALPINE-LINUX} include a shell.
Until recently these where used to interpret sysVinit scripts to boot the system but focus has moved to systemD style startup managers 
