...
The kernel provides these functions that perform complex tasks like launching executables, connecting to the network and accessing files.
...
Shell scripts written using the POSIX dialect are guarenteed,
