...
\section{Background}
The creation of the first unix shell by Ken Thompson at Bell Labs, birthplace of some of the greatest ideas and minds in computer science, was the beginning of true easy general purpose computing.
The Domain Specific Language(DSL) of the shell allows you to interact with the kernel in a simplified fashion launching programs 
