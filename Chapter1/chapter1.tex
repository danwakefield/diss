...
Every Linux distribution right down to the very smallest\cite{ALPINE-LINUX} include a shell of some form and generally it will comply, or have the option to, with the POSIX shell specification.

This spec was introduced well after most of the established shells were created 
