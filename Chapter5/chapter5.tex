...
It also would have allowed easy renaming of the variables package, using the builtin tool go fix.
This change has been needed since it became obvious that the package would end up holding more of the state than just 
