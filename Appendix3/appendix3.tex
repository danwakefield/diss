...
\end{lstlisting}
\caption[Code for a ]{Shows command grouping being used in the definition of a function, a conditional list and in a pipe.
\label{lst:if-ast-1}}
\end{figure}

\begin{figure}[h]
\lstinputlisting[language=json,caption={
