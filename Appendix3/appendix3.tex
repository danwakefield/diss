...
\end{lstlisting}
\caption[Shift helper functions]{Go's compile time checks prevent using an int64 as an argument to a shift, these functions perform the same math.\label{lst:arith-shift}}
\end{figure}
