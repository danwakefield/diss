...
\end{lstlisting}
\caption[Shell Command Grouping]{The interface required by the pratt parser for each node\cite{CROCKFORD-TDOP}. Differs from the examples by the addition of the parser arg to maintain state.
\label{lst:arith-node-interface}}
\end{figure}
