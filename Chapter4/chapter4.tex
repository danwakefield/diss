...
Functions without side effects can easily be tested this way and many others can be provided mocks to work in similar ways.
Providing the inputs and expected outputs for each function under test is perhaps the simplest way to 
